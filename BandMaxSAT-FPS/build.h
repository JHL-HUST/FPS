...
void BandMSFPS::build_neighbor_relation()
{
    int i, j, count;
    int v, c, n;
...
void BandMSFPS::build_instance(char *filename)
{
    istringstream iss;
    string line;
    char tempstr1[10];
...
void BandMSFPS::allocate_memory()
{
    ...
    score = new long long[malloc_var_length];  score2 = new long long[malloc_var_length];
    ...
    selected = new int [num_vars+10];
    best_vars = new int [sc_num+10];
    vars2 = new int [sc_num + 10]; 
    scores = new long long [sc_num + 10]; 
}

void BandMSFPS::free_memory()
{
    int i;
