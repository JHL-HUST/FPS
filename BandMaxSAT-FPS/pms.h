...
void BandMSFPS::update_goodvarstack1(int flipvar)
{
  	int v;
...
void BandMSFPS::update_goodvarstack12(int flipvar)
{
	int v;
...
void BandMSFPS::update_goodvarstack2(int flipvar)
{
...
void BandMSFPS::flip(int flipvar)
{
  	int i, v, c;
  	int index;
  	lit *clause_c;
...
void BandMSFPS::flip2(int flipvar)
{
	int i, v, c;
	int index;
	lit *clause_c;
  ...
  for (i = 0; i < var_neighbor_count[flipvar]; i++){
	...
	for (i = 0; i < var_lit_count[flipvar]; ++i)
	{
      ...
      int sc = sat_count[c] + 1;
			...
			{
				//sat_var2[c] = flipvar; //record the only true lit's var
				for (lit *p = clause_c; (v = p->var_num) != 0; p++)
				{
...
void BandMSFPS::print_best_solution()
{
...
inline void BandMSFPS::unsat(int clause)
{
...
inline void BandMSFPS::sat(int clause)
{
