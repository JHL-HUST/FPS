...
void MaxFPS::update_goodvarstack1(int flipvar)
{
	int v;
...
void MaxFPS::update_goodvarstack12(int flipvar)
{
	int v;
...
void MaxFPS::update_goodvarstack2(int flipvar)
{
...
void MaxFPS::print_best_solution()
{
...
inline void MaxFPS::unsat(int clause)
{
...
inline void MaxFPS::sat(int clause)
{
