...
void FPS::init(vector<int> &init_solution)
{
...
void FPS::local_search(char *inputfile)
{
...
void FPS::local_search_with_decimation(char *inputfile)
{
    settings();
...
void FPS::update_clause_weights()
{
