...
void FPS::update_goodvarstack1(int flipvar)
{
	int v;
...
void FPS::update_goodvarstack12(int flipvar)
{
	int v;
...
void FPS::update_goodvarstack2(int flipvar)
{
...
inline void FPS::unsat(int clause)
{
...
inline void FPS::sat(int clause)
{
